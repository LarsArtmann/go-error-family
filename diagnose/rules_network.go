...
func (r *NetworkRule) Run(ctx context.Context, err error) (*DiagnosticResult, error) { //nolint:hierarchical-errors // DiagnosticRule interface
	...
	if dnsErr != nil {
		...
		SetFix(result, "Check DNS resolution for "+host, "dig "+host)
		return result, nil
	}
